...
/// Service. It is responsible for fetching and persisting Quips to and from the
/// cloud.
///
/// Since we're trying to keep this example simple, it doesn't communicate with
/// a real server but simply emulates the functionality.
class QuipStaticRepo implements QuipRepo {
  const QuipStaticRepo();

  /// Mock that "fetches" some Quips from a "web service" after a short delay
  @override
